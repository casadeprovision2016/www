...
router.put('/info', auth_1.requireLeaderOrAdmin, (0, validation_1.validateAndSanitize)(validation_1.schemas.updateDonationInfo), donationsController_1.updateDonationInfo);
