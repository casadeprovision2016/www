/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: 8b236696510096f93add81e35c982ecc)
// Runtime types generated with workerd@1.20260210.0 2025-12-01 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		...
		NEXTJS_ENV: string;
		WORKER_SELF_REFERENCE: Fetcher /* www */;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "JWT_SECRET" | "NEXTJS_ENV">> {}
}
