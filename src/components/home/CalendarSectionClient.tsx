...
interface CalendarSectionClientProps {
  events: Event[]
}

export default function CalendarSectionClient({ events }: CalendarSectionClientProps) {
  ...
  const highlightedEvents = upcomingEvents.slice(0, 3)
